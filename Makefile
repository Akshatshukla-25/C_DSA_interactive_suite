...
$(TEST_DIR)/test_compression$(EXE): $(OBJ_DIR)/src/compression/rle.o $(OBJ_DIR)/src/compression/huffman.o $(OBJ_DIR)/src/compression/huffman_visualizer.o tests/compression/test_compression.c
	@$(call MKDIR_P,$(TEST_DIR))
	$(CC) $(CFLAGS) $^ -o $@ $(LDFLAGS)
